...
export const artist = [
  ...
  {
    id: 10,
    artistName: 'Pop Smoke ft Lil Baby',
  ...
  {
    id: 13,
    artistName: 'Busta Rhymes, Mariah Carey ft. Flipmode Squad',
    avatar: 'Busta_rhyme_Mariah_Carey-225x225.jpeg',
    songName: 'I Know What You Want',
  ...
  {
    id: 15,
    artistName: 'Jerry Rivera',
    songName: 'Amores Como el Nuestro',
...

  {
    id: 21,
    artistName: 'Marc Anthony',
    songName: 'Qué Precio Tiene el Cielo',
    Avatar: 'Marc_Anthony02-225 × 225.jpeg',
